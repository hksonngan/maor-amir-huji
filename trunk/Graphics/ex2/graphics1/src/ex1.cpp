...
void computeObjectInitScale()
{
	...
	float diff_up = sqrtf(x_dif_up*x_dif_up + y_dif_up*y_dif_up + z_dif_up*z_dif_up);
	float diff_low = sqrtf(x_dif_low*x_dif_low + y_dif_low*y_dif_low + z_dif_low*z_dif_low);
